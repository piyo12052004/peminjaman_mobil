        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-center font-semibold text-2xl">{{ __('Peminjaman') }}</h1>
                    <form method="post" action="/crud/produk/{{ $product->id }}" class="max-w-md mx-auto mt-5">
                        @csrf
                        @method('put')
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="merek_mobil" id="merek_mobil" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ old('stok_barang', $product->merek_mobil) }}" placeholder=" " readonly />
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="model_mobil" id="model_mobil" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ old('stok_barang', $product->model_mobil) }}" placeholder=" " readonly />
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="harga_sewa" id="harga_sewa" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ old('stok_barang', $product->harga_sewa) }}" placeholder=" " readonly />
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="nomer_plat" id="floating_nomer_plat" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="{{ old('stok_barang', $product->nomer_plat) }}" placeholder=" " readonly />
                        ...
                        <input type="hidden" name='verifikasi_mobil' value="Padding" >
                        
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 mt-5 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                    </form>
